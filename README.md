...
However, the UI isn't necessarily intuitive for everyone. While it offers a wealth of configuration options, manipulating nodes can present a high barrier for people who come from a drawing background.

We started this project because we believe the most natural way to generate images is to treat it like sketching in a notebook—and we wanted to bring that experience to life.
